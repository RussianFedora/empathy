...
* Mon Mar 11 2013 Brian Pepple <bpepple@fedoraproject.org> - 3.6.4-2
- Pull upstream patches to fix crash in IRC network chooser widget. (#881434)

* Mon Mar 11 2013 Brian Pepple <bpepple@fedoraproject.org> - 3.6.4-1
- Update to 3.6.4.
- Drop favorite rooms patch. Fixed upstream.

* Thu Jan 24 2013 Brian Pepple <bpepple@fedoraproject.org> - 3.6.3-2
- Pull upstream patch to fix empathy not saving favorite rooms. (#835805)

* Wed Jan  9 2013 Brian Pepple <bpepple@fedoraproject.org> - 3.6.3-1
- Update to 3.6.3

* Fri Nov 30 2012 Brian Pepple <bpepple@fedoraproject.org> - 3.6.2-2
